              ...
              {orders.filter((item) => {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td>
                        <img src="https://img.freepik.com/free-photo/top-view-arrangement-with-delicious-pakistan-meal_23-2148821534.jpg?t=st=1722078312~exp=1722081912~hmac=9ced514a886fd33459779357e602d1fe8baec63036ac7d4525a4c56a4e59913e&w=826" alt="item img" style={{width:"4rem"}}/>
                      </td>
                      <td>{item.name}</td>
                      <td>Rs. {item.price} /-</td>
                      <td>
